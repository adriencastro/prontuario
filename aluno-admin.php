    ...
    <header>
        <nav id="navbar">
            ...
            <?php if ($estaLogado): ?>
                ...
                <a href="logout-aluno.php"><button id="logoutButton" class="btn-default">Logout</button> </a>
            <?php else: ?>
                <a href="login-aluno.php"><button id="logoutButton" class="btn-default">Login</button></a>
            <?php endif; ?>
